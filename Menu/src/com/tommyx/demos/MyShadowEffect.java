...
public class MyShadowEffect extends APostProcessingEffect {
	...
	public MyShadowEffect(RajawaliScene scene, Camera camera, DirectionalLight light, int shadowMapSize) {
		super();
		mScene = scene;
		mCamera = camera;
		mLight = light;
