...
public class Fragment1 extends AFragment {
	...
	protected ARenderer createRenderer() {
		return new Fragment1Renderer(getActivity());
	}
	
	public final class Fragment1Renderer extends ARenderer {
		...
		public Fragment1Renderer(Context main) {
			super(main);
			sound1 = MediaPlayer.create(main, R.raw.intro);
		}
		...
		public void onDrawFrame(GL10 glUnused) {
			...
			if (counterset && linecounter == 3){
				...
				animcount = 50;
				duration = 500;
				showAnimatedText("__", new Vector3(20,-7,0));	
			}
			
			if (counterset && linecounter == 4){
				counterset = false;
				sound1.stop();
				((main) mContext).launchFragment(new Fragment2());
			}
