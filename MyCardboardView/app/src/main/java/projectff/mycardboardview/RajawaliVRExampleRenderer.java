...
public class RajawaliVRExampleRenderer extends RajawaliCardboardRenderer implements IRajawaliSurfaceRenderer, IAsyncLoaderCallback {
	float count = 0;
	...
	public void initScene() {
		...
		try {
			...
			loadModel(loader, this, R.raw.model);
	...
	public SkeletalAnimationObject3D showMonster(String Monster, Vector3 pos, Vector3 rot, Vector3 scale, int fps){
		...
		int mesh = getContext().getResources().getIdentifier(Monster + "_mesh", "raw", "projectff.mycardboardview");
	...
	public void loadAnim2Obj(SkeletalAnimationObject3D obj, String animname, boolean loop)
	{
		...
		int anim = getContext().getResources().getIdentifier(animname, "raw", " projectff.mycardboardview");
	...
	public void onDrawFrame(GL10 glUnused) {
		...
		count+=0.1f;
        getCurrentCamera().setPosition(player.getPosition().x,player.getPosition().y,player.getPosition().z);
